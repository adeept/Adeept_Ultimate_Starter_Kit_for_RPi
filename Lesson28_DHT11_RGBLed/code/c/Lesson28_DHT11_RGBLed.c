...
void rgbTest(int h)
{
    ...
    printf("RED\n");
    ledColorSet(h, 0xFF0000);
    delay_ms(1000);

    printf("GREEN\n");
    ledColorSet(h, 0x00FF00);
    delay_ms(1000);

    printf("BLUE\n");
    ledColorSet(h, 0x0000FF);
    delay_ms(1000);

    ledColorSet(h, 0x000000);

    printf("RGB LED test finished\n\n");
}
...
int main(void)
{
    ...
    printf("Raspberry Pi DHT11 + RGB LED Test\n");
    printf("DHT11 = BCM%d\n", DHT_PIN);
    ...
    // Start DHT11 control
    printf("Start DHT11 control RGB LED\n\n");
